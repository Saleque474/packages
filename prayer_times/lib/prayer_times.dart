...
// return prayer times for given date
  GeneratedPrayerTimes getTimes(
      DateTime date, double _latitude, double longitude, double timezone,
      {elevation,
      dst = false,
    ...
    formatInString ??= format.format;

    _timeFormat = formatInString;
...
//_adjust times in a prayer time array
  Map _adjustTimes(Map times) {
    ...
    if (params['highLats'] != null) times = _adjustHighLats(times);
